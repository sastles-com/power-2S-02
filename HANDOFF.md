...
5. **部品選定** — 全部品に LCSC 番号を設定 ([`docs/05`](docs/05-jlcpcb-fab.md) §2)。主要 IC 2 個は確定済み。残り:
   - [ ] 充電段 L1: **2.2 µH / Isat ≥5 A / DCR <20 mΩ / CD43 (4.5×4.5 mm)**
   - [ ] 降圧段 L1: **4.7 µH / Isat・Idc ≥5 A / DCR ≤30 mΩ / シールド**
   - [ ] **D2 外付け BST ダイオード: BAT54 (SOD-323) か 1N4148W**
   - [ ] セラコン **25 V 耐圧品** — 2P 版実績番号 (C2980800 / C12891) は耐圧要確認。両段とも 25 V 指定
