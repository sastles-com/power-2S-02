...
| セラコン 0603 (CL10) | C15849 等 | 1 (−20, 0) / 2 (+20, 0) |
| セラコン 0805 (CL21) | C1779 等 | **1 (−15, 0) / 2 (+15, 0)** ← 0603 より狭い |
...
⚠️ **読み取りと書き込みで形式が違う**: `getState_Line()` は
**`[[x2,y2,x1,y1]]` (入れ子 + 点の順序が逆)** で返る。書き込み値をそのまま読み戻せない。
