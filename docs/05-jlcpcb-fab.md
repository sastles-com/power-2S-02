...
6. **2P 版で実績のある LCSC 番号を初期値として使える** (2026-08-10 実測):
...
| ⚠️ 上 2 点は**耐圧を確認してから**流用 | — | 充電段は **25 V 品**指定 ([`docs/02`](02-ip2326-module.md) §3.9)。降圧段も DC バイアス減衰対策で **25 V 品**を選ぶ ([`docs/03`](03-mp1584-module.md) §3.6) |
